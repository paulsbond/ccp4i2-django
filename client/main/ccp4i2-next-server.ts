...
export const startNextServer = async (
  ...
  const csp = {
    ...
    connectSrc: `http://localhost:${nextServerPort} ws://localhost:${nextServerPort} https://www.ebi.ac.uk https://www.uniprot.org https://pubmed.ncbi.nlm.nih.gov https://raw.githubusercontent.com/MonomerLibrary/monomers/master/ https://login.microsoftonline.com https://graph.microsoft.com`,
    styleSrc:
