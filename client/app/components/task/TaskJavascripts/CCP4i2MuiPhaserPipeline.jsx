...
export const CCP4i2MuiPhaserPipeline = (props_in) => {
    ...
    return <CCP4i2ToplevelTask taskName='phaser_pipeline' onChange={handleChange} onInitial={() => {
        const currentFlag = props.lookup.itemForName('F_SIGF').contentFlag._value
        if ([2, 4].includes(currentFlag)) {
            props.lookup.changeParameter(props.job.jobid,
        ...
        <CCP4i2MuiTabs type="line" {...props}>
            <CCP4i2MuiTab tab="Main inputs" key="1">
                <CCP4i2MuiContainer  {...props} guiLabel="Key files" containerHint="FolderLevel" initiallyOpen={true} >
                    ...
                    <CCP4i2MuiWidget {...props} key="ENSEMBLES" itemName="ENSEMBLES" guiLabel="Ensembles" />
                </CCP4i2MuiContainer>
